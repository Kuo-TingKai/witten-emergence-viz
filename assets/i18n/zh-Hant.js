...
window.I18N["zh-Hant"] = {
  ...
  game: {
    ...
    advice: {
      lethal: "可以斬殺！點你發光的單位，再點 Carl 頭像收掉這局",
      lethalBolt: "打出這張就能直接斬殺 Carl！",
      clearTaunt: "打出這張法術，再點 Carl 發光的嘲諷牆把它轟掉",
      attackTaunt: "Carl 的嘲諷牆擋路：點你發光的單位，再點 Carl 發光的嘲諷牆把它清掉",
      removeThreat: "打出這張法術，再點 Carl 發光的大單位把它解掉",
      playTaunt: "打出這張當牆，擋住 Carl 的攻擊",
      playImmune: "打出這張：免疫法術的硬單位，難被清掉",
      playStruct: "打出這張結構：擋法術與熵傷害",
      develop: "鋪場：打出單位來累積攻擊力與糾纏護盾",
      draw: "手牌不多，打這張多抽 2 張保持牌量",
      dot: "打這張：之後每回合自動扣 Carl 血、無法移除，對烏龜流超有效",
      aoe: "Carl 場上單位多，用這張一次清場",
      shield: "打這張補護盾，先穩住場面",
      reconstruct: "用這張把棄牌堆的好牌撿回來",
      attackFace: "點你發光的單位，再點 Carl 頭像攻擊他本體（結構擋不住單位！）",
      play: "打出這張",
      end: "這回合沒有更好的選擇了，結束回合交給 Rovelli"
    },
    ...
    cards: {
      ...
      happy:  { text: "結構：法術與熵對你本體的傷害 −1（擋不住單位直接攻擊）。", flavor: "HaPPY 張量網絡：容錯是宇宙內建的存檔方式。" },
      ...
      lqg_planck:      { name: "普朗克離散", text: "結構：法術與熵對你本體的傷害 −1（擋不住單位直接攻擊）。", flavor: "存在最小長度，時空在普朗克尺度是離散的——傷害打不穿這個底。" },

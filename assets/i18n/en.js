...
window.I18N["en"] = {
  ...
  game: {
    ...
    advice: {
      lethal: "Lethal! Click your glowing unit, then Carl’s portrait to finish him",
      lethalBolt: "Play this to finish Carl off right now!",
      clearTaunt: "Play this spell, then click Carl’s glowing Taunt wall to blast it",
      attackTaunt: "Carl’s Taunt wall blocks you: click your glowing unit, then his glowing Taunt wall to clear it",
      removeThreat: "Play this spell, then click Carl’s glowing big unit to remove it",
      playTaunt: "Play this as a wall to soak Carl’s attacks",
      playImmune: "Play this: a spell-immune body that’s hard to remove",
      playStruct: "Play this structure: cuts spell & entropy damage",
      develop: "Develop: play a unit to build attack power and entanglement shield",
      draw: "Low on cards — play this to draw 2 and keep your hand full",
      dot: "Play this: chips Carl every turn and can’t be removed — great vs a turtle",
      aoe: "Carl has a wide board — sweep it with this",
      shield: "Play this for shield to stabilize first",
      reconstruct: "Use this to pull a good card back from your discard pile",
      attackFace: "Click your glowing unit, then Carl’s portrait to hit his hero (structure can’t stop units!)",
      play: "Play this card",
      end: "Nothing better this turn — end it and pass to Rovelli"
    },

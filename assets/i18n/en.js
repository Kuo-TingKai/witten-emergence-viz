...
window.I18N["en"] = {
  ...
  game: {
    ...
    advice: {
      ...
      clearTaunt: "Use this to blast the Taunt wall first, then you can hit Carl’s hero",
      attackTaunt: "Carl’s Taunt wall is blocking — clear it with your units first",
      removeThreat: "Use this to remove Carl’s big unit before it trades into you",
      ...
      attackFace: "Attack Carl’s hero with your units (structure can’t stop unit attacks!)",
      play: "Play this card",
